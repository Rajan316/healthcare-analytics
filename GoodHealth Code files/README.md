...
## Objective
Good Health case study aims to predict whether or not a patient has a risk of having diabetes or not based on various factors.

## Dataset description

The Pima Indians Diabetes dataset is taken from Machine Learning Repository UCI: https://archive.ics.uci.edu/ml/datasets/pima+indians+diabetes.
